...
ticker_metadata = client.get_ticker_metadata("GOOGL") # Get Ticker Metadata for the stock "GOOGL"
tickers = client.list_stock_tickers() # See what tickers are available
...
ticker_history_df = client.get_dataframe("GOOGL",startDate='2018-05-15',endDate='2018-05-31',frequency='daily')
multiple_ticker_history_df = client.get_dataframe(['GOOGL', 'AAPL'],frequency='weekly',metric_name='volume',startDate='2018-01-01',endDate='2018-07-31')

'''
-- end of day frequencies: daily, weekly, monthly, annually)
     --- Weekly frequencies resample to the end of day on Friday, 
     --- monthly frequencies resample to the last day of the month, and 
     --- annually frequencies resample to the end of day on 12-31 of each year. 
