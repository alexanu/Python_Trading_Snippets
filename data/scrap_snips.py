...
html = urllib.request.urlopen(url).read().decode('cp1252').encode('utf-8') # re-encode to utf-8 to avoid gzip
soup = bs(html, "lxml")
...
######################################################################
https://old.nasdaq.com/symbol/aaon/short-interest
symbols=['AAPL','DSX','MSFT']
for symbol in symbols:
    url="https://old.nasdaq.com/symbol/"+symbol+"/short-interest"
...
url='https://www.nasdaq.com/market-activity/stocks/msft/short-interest'
...
resp = requests.get('https://old.nasdaq.com/symbol/aaon/short-interest')
print('Done')
...
import csv
url = urlopen("https://fundamentals.nasdaq.com/redpage.asp?selected=AAPL&market=NASDAQ-GS&LogoPath=https%3a%2f%2fwww.nasdaq.com%2flogos%2fAAPL.GIF&coname=Apple%20Inc.")
mylist = []
