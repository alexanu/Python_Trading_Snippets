# Source: https://github.com/cottrell/hrp
...
def getQuasiDiag(link):
    ...
    while sortIx.max() >= numItems:
        ...
        sortIx[i] = link[j, 0]  # item 1REPRODUCING THE NUMERICAL EXAMPLE
